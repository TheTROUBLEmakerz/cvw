...
module ieu(
        ...
        input   logic           StallD, FlushD, StallE, FlushE, IsMulW,
        ...
        input   logic [31:0]    ReadData, ImmExtW,
        output  logic [31:0]    ImmExtE, PCLinkE,
    ...
    mux4 #(32) resultmux(extoutW, ReadDataW, ImmExtW, CSRout, ResultSrcW, ResultW);
